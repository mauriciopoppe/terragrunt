...
[![Go Report Card](https://goreportcard.com/badge/github.com/mauriciopoppe/terragrunt)](https://goreportcard.com/report/github.com/mauriciopoppe/terragrunt)
[![GoDoc](https://godoc.org/github.com/mauriciopoppe/terragrunt?status.svg)](https://godoc.org/github.com/mauriciopoppe/terragrunt)
...
Terragrunt has not yet been updated to be compatible with Terraform 0.12. We're working on it! Follow along in https://github.com/mauriciopoppe/terragrunt/issues/466.

## Quick start

1. [Install Terraform](https://www.terraform.io/intro/getting-started/install.html).

1. Install Terragrunt by going to the [Releases Page](https://github.com/mauriciopoppe/terragrunt/releases),
...
1. Check out the [terragrunt-infrastructure-modules-example](https://github.com/mauriciopoppe/terragrunt-infrastructure-modules-example)
   and [terragrunt-infrastructure-live-example](https://github.com/mauriciopoppe/terragrunt-infrastructure-live-example)
...
[Releases Page](https://github.com/mauriciopoppe/terragrunt/releases).
...
### Manual
You can install Terragrunt manually by going to the [Releases Page](https://github.com/mauriciopoppe/terragrunt/releases),
downloading the binary for your OS, renaming it to `terragrunt`, and adding it to your PATH.
...
Check out the [terragrunt-infrastructure-modules-example](https://github.com/mauriciopoppe/terragrunt-infrastructure-modules-example)
and [terragrunt-infrastructure-live-example](https://github.com/mauriciopoppe/terragrunt-infrastructure-live-example)
...
the included file's terragrunt = { ... } configuration into `mysql/terraform.tfvars`, but this approach is much easier to maintain! Including variables defined outside of the terragrunt block is discussed in [#132](https://github.com/mauriciopoppe/terragrunt/issues/132).
...
To release a new version, just go to the [Releases Page](https://github.com/mauriciopoppe/terragrunt/releases) and
